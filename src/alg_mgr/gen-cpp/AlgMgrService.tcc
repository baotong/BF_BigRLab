...
uint32_t AlgMgrService_availablePort_args::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t AlgMgrService_availablePort_args::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("AlgMgrService_availablePort_args");
...
template <class Protocol_>
uint32_t AlgMgrService_availablePort_pargs::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("AlgMgrService_availablePort_pargs");
...
template <class Protocol_>
uint32_t AlgMgrService_availablePort_result::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t AlgMgrService_availablePort_result::write(Protocol_* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("AlgMgrService_availablePort_result");
...
template <class Protocol_>
uint32_t AlgMgrService_availablePort_presult::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t AlgMgrService_getAlgSvrList_args::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t AlgMgrService_getAlgSvrList_args::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("AlgMgrService_getAlgSvrList_args");
...
template <class Protocol_>
uint32_t AlgMgrService_getAlgSvrList_pargs::write(Protocol_* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("AlgMgrService_getAlgSvrList_pargs");
...
template <class Protocol_>
uint32_t AlgMgrService_getAlgSvrList_result::read(Protocol_* iprot) {
...
template <class Protocol_>
uint32_t AlgMgrService_getAlgSvrList_result::write(Protocol_* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("AlgMgrService_getAlgSvrList_result");

  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<AlgSvrInfo> ::const_iterator _iter14;
...
template <class Protocol_>
uint32_t AlgMgrService_getAlgSvrList_presult::read(Protocol_* iprot) {
...
template <class Protocol_>
int16_t AlgMgrServiceClientT<Protocol_>::availablePort()
{
  send_availablePort();
  return recv_availablePort();
}

template <class Protocol_>
void AlgMgrServiceClientT<Protocol_>::send_availablePort()
{
  int32_t cseqid = 0;
  this->oprot_->writeMessageBegin("availablePort", ::apache::thrift::protocol::T_CALL, cseqid);

  AlgMgrService_availablePort_pargs args;
...
template <class Protocol_>
int16_t AlgMgrServiceClientT<Protocol_>::recv_availablePort()
{
  ...
  if (fname.compare("availablePort") != 0) {
    this->iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    this->iprot_->readMessageEnd();
    this->iprot_->getTransport()->readEnd();
  }
  int16_t _return;
  AlgMgrService_availablePort_presult result;
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "availablePort failed: unknown result");
}
...
template <class Protocol_>
void AlgMgrServiceClientT<Protocol_>::getAlgSvrList(std::vector<AlgSvrInfo> & _return, const std::string& name)
{
  send_getAlgSvrList(name);
  recv_getAlgSvrList(_return);
}

template <class Protocol_>
void AlgMgrServiceClientT<Protocol_>::send_getAlgSvrList(const std::string& name)
{
  int32_t cseqid = 0;
  this->oprot_->writeMessageBegin("getAlgSvrList", ::apache::thrift::protocol::T_CALL, cseqid);

  AlgMgrService_getAlgSvrList_pargs args;
  args.name = &name;
  args.write(this->oprot_);
...
template <class Protocol_>
void AlgMgrServiceClientT<Protocol_>::recv_getAlgSvrList(std::vector<AlgSvrInfo> & _return)
{
  ...
  if (fname.compare("getAlgSvrList") != 0) {
    this->iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    this->iprot_->readMessageEnd();
    this->iprot_->getTransport()->readEnd();
  }
  AlgMgrService_getAlgSvrList_presult result;
  result.success = &_return;
  result.read(this->iprot_);
  this->iprot_->readMessageEnd();
  this->iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "getAlgSvrList failed: unknown result");
}
...
template <class Protocol_>
void AlgMgrServiceProcessorT<Protocol_>::process_availablePort(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("AlgMgrService.availablePort", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "AlgMgrService.availablePort");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "AlgMgrService.availablePort");
  }

  AlgMgrService_availablePort_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "AlgMgrService.availablePort", bytes);
  }

  AlgMgrService_availablePort_result result;
  try {
    result.success = iface_->availablePort();
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "AlgMgrService.availablePort");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("availablePort", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "AlgMgrService.availablePort");
  }

  oprot->writeMessageBegin("availablePort", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "AlgMgrService.availablePort", bytes);
  }
}

template <class Protocol_>
void AlgMgrServiceProcessorT<Protocol_>::process_availablePort(int32_t seqid, Protocol_* iprot, Protocol_* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("AlgMgrService.availablePort", callContext);
...
template <class Protocol_>
void AlgMgrServiceProcessorT<Protocol_>::process_getAlgSvrList(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("AlgMgrService.getAlgSvrList", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "AlgMgrService.getAlgSvrList");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "AlgMgrService.getAlgSvrList");
  }

  AlgMgrService_getAlgSvrList_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "AlgMgrService.getAlgSvrList", bytes);
  }

  AlgMgrService_getAlgSvrList_result result;
  try {
    iface_->getAlgSvrList(result.success, args.name);
    result.__isset.success = true;
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "AlgMgrService.getAlgSvrList");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("getAlgSvrList", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "AlgMgrService.getAlgSvrList");
  }

  oprot->writeMessageBegin("getAlgSvrList", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "AlgMgrService.getAlgSvrList", bytes);
  }
}

template <class Protocol_>
void AlgMgrServiceProcessorT<Protocol_>::process_getAlgSvrList(int32_t seqid, Protocol_* iprot, Protocol_* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("AlgMgrService.getAlgSvrList", callContext);
...
template <class Protocol_>
int16_t AlgMgrServiceConcurrentClientT<Protocol_>::availablePort()
{
  int32_t seqid = send_availablePort();
  return recv_availablePort(seqid);
}

template <class Protocol_>
int32_t AlgMgrServiceConcurrentClientT<Protocol_>::send_availablePort()
{
...
template <class Protocol_>
int16_t AlgMgrServiceConcurrentClientT<Protocol_>::recv_availablePort(const int32_t seqid)
{
...
template <class Protocol_>
void AlgMgrServiceConcurrentClientT<Protocol_>::getAlgSvrList(std::vector<AlgSvrInfo> & _return, const std::string& name)
{
  int32_t seqid = send_getAlgSvrList(name);
  recv_getAlgSvrList(_return, seqid);
}

template <class Protocol_>
int32_t AlgMgrServiceConcurrentClientT<Protocol_>::send_getAlgSvrList(const std::string& name)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  this->oprot_->writeMessageBegin("getAlgSvrList", ::apache::thrift::protocol::T_CALL, cseqid);
...
template <class Protocol_>
void AlgMgrServiceConcurrentClientT<Protocol_>::recv_getAlgSvrList(std::vector<AlgSvrInfo> & _return, const int32_t seqid)
{
