...
public:
    ...
    virtual void toVector(std::vector<double> & _return, const std::string& sentence, const bool wordseg = true);
    virtual void knn(std::vector<KnnResult> & _return, const std::string& sentence, 
            const int32_t n, const int32_t searchK, const bool wordseg = true);
