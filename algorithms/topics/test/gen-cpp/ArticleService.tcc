...
template <class Protocol_>
void ArticleServiceClientT<Protocol_>::knn(std::vector<KnnResult> & _return, const std::string& sentence, const int32_t n, const int32_t searchK, const bool wordseg)
{
  send_knn(sentence, n, searchK, wordseg);
  recv_knn(_return);
}

template <class Protocol_>
void ArticleServiceClientT<Protocol_>::send_knn(const std::string& sentence, const int32_t n, const int32_t searchK, const bool wordseg)
{
  int32_t cseqid = 0;
...
void ArticleServiceProcessorT<Protocol_>::process_knn(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->knn(result.success, args.sentence, args.n, args.searchK, args.wordseg);
    result.__isset.success = true;
  } catch (InvalidRequest &err) {
    result.err = err;
    result.__isset.err = true;
...
template <class Protocol_>
void ArticleServiceConcurrentClientT<Protocol_>::knn(std::vector<KnnResult> & _return, const std::string& sentence, const int32_t n, const int32_t searchK, const bool wordseg)
{
  int32_t seqid = send_knn(sentence, n, searchK, wordseg);
  recv_knn(_return, seqid);
}

template <class Protocol_>
int32_t ArticleServiceConcurrentClientT<Protocol_>::send_knn(const std::string& sentence, const int32_t n, const int32_t searchK, const bool wordseg)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  this->oprot_->writeMessageBegin("knn", ::apache::thrift::protocol::T_CALL, cseqid);
