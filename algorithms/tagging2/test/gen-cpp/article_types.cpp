...
TagResult::TagResult(const TagResult& other8) {
  tag = other8.tag;
  weight = other8.weight;
  __isset = other8.__isset;
}
TagResult::TagResult( TagResult&& other9) {
  tag = std::move(other9.tag);
  weight = std::move(other9.weight);
  __isset = std::move(other9.__isset);
}
TagResult& TagResult::operator=(const TagResult& other10) {
  tag = other10.tag;
  weight = other10.weight;
  __isset = other10.__isset;
  return *this;
}
TagResult& TagResult::operator=(TagResult&& other11) {
  tag = std::move(other11.tag);
  weight = std::move(other11.weight);
